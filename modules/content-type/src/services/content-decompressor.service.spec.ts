...
describe('content-decompressor.service.ts', function() {
    ...
    describe('ContentDecompressorService.decompress()', function() {
        ...
        it('should decoded deflate encoded content', async function() {
            ...
            expect(decompressed.toString()).to.equal('恢复神经系统🌿 轻柔的音乐，镇静神经系统，愉悦心灵')
        })
        ...
        it('should return it self if given encoding is identity', async function() {
            ...
            expect(decompressed.toString('base64')).to.equal(raw_str)
        })
    ...
    describe('ContentDecompressorService.load_decompressor()', function() {
        ...
        it('should load gzip decompressor by import', async function() {
            ...
            expect(failed_decompressed.toString('base64')).to.equal(raw_str)
            ...
            expect(succeed_decompressed.toString()).to.equal('恢复神经系统🌿 轻柔的音乐，镇静神经系统，愉悦心灵')
        })
        ...
        it('should handle error event', async function() {
            const raw = Buffer.from('eJx71rjo6ZLe50vnPd/d/3zz7ue753+Y37Nf4cXe3c/mT3k+q+Xl/M1Pdk54v6fn5dT2l3NnIisECj5r6XzWtOzp/ubnjVsBvhQ0uQ==', 'base64')
            expect(decompressor.decompress(raw, { content_encoding: 'err' })).to.be.rejected
        })
    })
})
