...
describe('connection case', () => {
    ...
    describe('error occurred when connecting', () => {
        ...
        it('should use custom strategy if provided, will stop retry if throw error from on_failed', async () => {
            ...
            const platform = new Platform(load_config<TpConfigSchema>({ rabbitmq: { url: {}, timeout: 200 } }))
    ...
    describe('client-initiated disconnection', () => {

        it('should gracefully close the connection without errors', async () => {
