...
import { TpAuthInfo, TpSession } from '../types'
...
export class SessionContext {
    ...
    private _custom_data: Partial<TpSession> = {}

    constructor(
        private _ctx: LiteContext,
        private _auth_info: TpAuthInfo | undefined,
     ...
     */
    get auth_info(): TpAuthInfo | undefined {
     ...
     * @param value
     */
    set_data<M extends keyof TpSession>(key: M, value: TpSession[M]) {
     ...
     * @param key
     */
    get_data<M extends keyof TpSession>(key: M): TpSession[M] | undefined {
